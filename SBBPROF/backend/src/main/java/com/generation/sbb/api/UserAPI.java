...
public class UserAPI {
    ...
    /**
        loginDTO => nome utente e password 
        mi arriva tramite post perché le chiamate get non sono adatte
        i parametri sono visibili nell'indirizzo se passo le info come parametri
    */
    @PostMapping("/login")
