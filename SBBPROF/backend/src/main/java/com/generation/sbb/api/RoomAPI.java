...
public class RoomAPI {
  ...
  @GetMapping("/free/{id}/{from}/{to}")
    public List<RoomCategoryDTO> findAll(@PathVariable("id") int id, @PathVariable("from") LocalDate from, @PathVariable("to") LocalDate to) {
        return service.findFreeRoomsInHotel(id, from, to);
    }
